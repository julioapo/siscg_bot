        ...
        <section class="panel">
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a href="{$_layoutParams.root}{$ruta_agregar}/{$id_mamat}">
                    ...
                    <table id="table_id" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        ...
                        {foreach item=datos from=$infbank}
                            <tr>
                                ...
                                <td><a href="#" data-toggle="tooltip" title="Eliminar" onclick="javascript:return pregunta('{$_layoutParams.root}mamat/dropCueMamat/{$datos.id_mamat}/{$datos.nro_cuenta}/{$datos.id_banco}');"><i class="fa fa-trash-o col-md-1"></i></a></td>
                            </tr>
                        {/foreach}
                        </tbody>
                    </table>
